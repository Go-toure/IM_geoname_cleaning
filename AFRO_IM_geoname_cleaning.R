setwd("C:/Users/TOURE/Mes documents/REPOSITORIES/IM_raw_data/")
...
#read_all_files
A<- read_csv("C:/Users/TOURE/Mes documents/REPOSITORIES/IM_raw_data/AFRO_IM_data.csv")
...
IM$rnd_distinct <- paste(IM$country,IM$province, IM$district, IM$response, IM$roundNumber, IM$start_date, sep = "_")

IM<-IM |> 
  distinct(rnd_distinct, .keep_all = TRUE)


write_csv(IM,"C:/Users/TOURE/Mes documents/REPOSITORIES/IM_raw_data/AFRO_Inside_HH_M.csv")
